...
```{r}
cd C:\Users\morte\Documents\Skole\Spring 2024\BIO 415\Module 1
```
...
usethis::use_git_remote(
  name = "origin",
  url = "git@github.com:jennybc/happy-git-with-r.git",
  overwrite = TRUE)
```
...
In the {r} command you can choose to exclude the code from your text using include=False so it looks like this {r, include=False} for data that is not to important include. You can also name the chunks {r, Mean_temp} so you can make it more easy to know what the code does.
...
# Looking at the data the largest ratio of total sun to rainfall ratio from 1900 to 1990

# is Cambridge with a ratio of 2.85
